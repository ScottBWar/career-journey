...
window.Portraits = (function () {
  ...
  const SPEC = {
    ...
    kuato:     { type: 'survivor',  skin: '#b8845a', hair: '#2a1810', eye: '#ff5a4a', bg: '#7a3320' },
    brundle:   { type: 'wanderer',  skin: '#cdbfae', hair: '#3a2e2a', eye: '#b0202a', bg: '#2a3038' },
    didymus:   { type: 'knight',    skin: '#c2702a', hair: '#e0c040', eye: '#2a1a10', bg: '#2f6a3a' },
    zed:       { type: 'hunter',    skin: '#c08a5a', hair: '#1a1208', eye: '#3a2a1a', bg: '#3a6a4a' },
