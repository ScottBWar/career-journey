...
window.Progress = (function () {
  ...
  function freshState() {
    ...
    const state = {
      ...
      islands: { tidehaven: { cleared: {} }, dunes: { cleared: {} }, spire: { cleared: {} }, mall: { cleared: {} }, duskmoor: { cleared: {} }, mirage: { cleared: {} }, aerie: { cleared: {} }, paegina: { cleared: {} } },
      coliseum: {},
      dungeons: {}, shipsSunk: {},
  ...
  function migrate(state) {
    ...
    ['tidehaven', 'dunes', 'spire', 'mall', 'duskmoor', 'mirage', 'aerie', 'paegina'].forEach(k => { if (!state.islands[k]) state.islands[k] = { cleared: {} }; });
